        ...
        <AdminLayout title="Tambah Baglog">
            ...
            <div className="bg-surface-container-lowest rounded-xl shadow-clinical-sm max-w-2xl">
                <div className="p-6 border-b border-outline-variant/15">
                    <h2 className="text-lg font-headline font-bold text-on-surface">Tambah Baglog Baru</h2>
                    <p className="text-sm text-on-surface-variant">Catat produksi atau pembelian baglog</p>
                </div>
