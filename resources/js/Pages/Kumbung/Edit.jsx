                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-6">
                            ...
                            {/* Current Stats */}
                            <div className="bg-surface-container-lowest rounded-xl shadow-clinical-sm p-6">
                                <h3 className="text-sm font-medium text-on-surface-variant mb-3">Status Saat Ini</h3>
                                <div className="space-y-2">
                                    <div className="flex justify-between text-sm">
                                        <span className="text-on-tertiary-container">Baglog Aktif</span>
                                        <span className="font-medium">{kumbung.baglog_aktif || 0}</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                                        <span className="text-on-tertiary-container">Kapasitas Tersedia</span>
