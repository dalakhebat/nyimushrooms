...
export default function CreateBaglog({ customers, stockBaglog }) {
    ...
    return (
        <AdminLayout title="Tambah Penjualan Baglog">
            <Head title="Tambah Penjualan Baglog" />
            ...
            {/* Stock Info */}
            <div className={`mb-4 p-4 rounded-xl ${stockBaglog > 0 ? 'bg-blue-50 border border-blue-200' : 'bg-red-50 border border-red-200'}`}>
                <div className="flex items-center justify-between">
                    <div>
                        <p className="text-sm font-medium text-on-surface-variant">Stock Baglog Tersedia (Pembibitan)</p>
            ...
            <div className="bg-surface-container-lowest rounded-xl shadow-clinical-sm max-w-2xl">
                <div className="p-6 border-b border-outline-variant/15">
                    <h2 className="text-lg font-headline font-bold text-on-surface">Tambah Penjualan Baglog</h2>
                    <p className="text-sm text-on-surface-variant">Catat penjualan baglog baru</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="flex items-center justify-end gap-3 pt-4 border-t">
                        ...
                        <button
                            type="submit"
                            disabled={processing || exceedsStock || stockBaglog === 0}
