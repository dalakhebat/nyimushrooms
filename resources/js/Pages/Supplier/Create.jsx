...
export default function SupplierCreate() {
    ...
    return (
        <AdminLayout title="Tambah Supplier">
            ...
            <div className="bg-surface-container-lowest rounded-xl shadow-clinical-sm max-w-2xl">
                <div className="p-6 border-b border-outline-variant/15">
                    <h2 className="text-lg font-headline font-bold text-on-surface">Tambah Supplier Baru</h2>
                    <p className="text-sm text-on-surface-variant">Masukkan data supplier bahan baku</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Contoh: Toko Serbuk Jaya"
                        />
