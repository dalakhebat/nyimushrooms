        ...
        <AdminLayout title="Edit Monitoring">
            ...
            <div className="max-w-2xl">
                ...
                <div className="bg-surface-container-lowest rounded-xl shadow-clinical-sm p-6">
                    <h2 className="text-lg font-bold text-on-surface mb-6">Edit Monitoring</h2>
                    ...
                    <FormAlert errors={errors} />
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="time" value={data.waktu} onChange={(e) => setData('waktu', e.target.value)} className="w-full px-4 py-2 border border-outline-variant/30 rounded-xl focus:ring-2 focus:ring-secondary" />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" value={data.suhu} onChange={(e) => setData('suhu', e.target.value)} step="0.1" className="w-full px-4 py-2 border border-outline-variant/30 rounded-xl focus:ring-2 focus:ring-secondary" />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-on-surface-variant mb-1">Kelembaban (%)</label>
                                <input type="number" value={data.kelembaban} onChange={(e) => setData('kelembaban', e.target.value)} step="0.1" className="w-full px-4 py-2 border border-outline-variant/30 rounded-xl focus:ring-2 focus:ring-secondary" />
                            </div>
                        </div>

                        <div>
                            <label className="block text-sm font-medium text-on-surface-variant mb-1">Kondisi Baglog</label>
                            <select value={data.kondisi_baglog} onChange={(e) => setData('kondisi_baglog', e.target.value)} className="w-full px-4 py-2 border border-outline-variant/30 rounded-xl focus:ring-2 focus:ring-secondary">
                        ...
                        <div className="flex items-center space-x-6">
                            <label className="flex items-center">
                                <input type="checkbox" checked={data.sudah_spray} onChange={(e) => setData('sudah_spray', e.target.checked)} className="w-4 h-4 text-secondary border-outline-variant/30 rounded focus:ring-secondary" />
                                <span className="ml-2 text-sm text-on-surface-variant">Sudah Spray</span>
                            </label>
                            <label className="flex items-center">
                                <input type="checkbox" checked={data.sudah_siram} onChange={(e) => setData('sudah_siram', e.target.checked)} className="w-4 h-4 text-secondary border-outline-variant/30 rounded focus:ring-secondary" />
                        ...
                        <div>
                            ...
                            {karyawans.length === 0 ? (
                                ...
                                <select value={data.karyawan_id} onChange={(e) => setData('karyawan_id', e.target.value)} className="w-full px-4 py-2 border border-outline-variant/30 rounded-xl focus:ring-2 focus:ring-secondary">
                        ...
                        <div>
                            ...
                            <textarea value={data.catatan} onChange={(e) => setData('catatan', e.target.value)} rows="3" className="w-full px-4 py-2 border border-outline-variant/30 rounded-xl focus:ring-2 focus:ring-secondary" />
                        </div>

                        <div className="flex items-center justify-end space-x-3 pt-4">
                            <Link href="/monitoring-kumbung" className="px-4 py-2 text-sm font-medium text-on-surface-variant bg-surface-container-low rounded-xl hover:bg-gray-200">Batal</Link>
                            <button type="submit" disabled={processing} className="px-4 py-2 text-sm font-medium text-white bg-primary rounded-xl hover:bg-primary disabled:opacity-50">{processing ? 'Menyimpan...' : 'Update'}</button>
                        </div>
                    </form>
                </div>
            </div>
