...
export default function KaryawanCreate({ today }) {
                        ...
                        <div>
                            ...
                            <div className="flex space-x-2">
                                <input
                                    ...
                                    maxLength={6}
                                    className="flex-1 px-4 py-2 border border-outline-variant/30 rounded-xl focus:ring-2 focus:ring-secondary focus:border-green-500 font-mono tracking-widest"
                                />
                                <button
                                    type="button"
                                    onClick={generateRandomPin}
                                    className="px-4 py-2 text-sm font-medium text-secondary bg-emerald-100 rounded-xl hover:bg-green-200 transition-colors"
                                >
                                    Generate
                                </button>
                            </div>
                            <p className="mt-1 text-xs text-on-tertiary-container">PIN digunakan untuk absensi QR Code</p>
                            {errors.pin && (
