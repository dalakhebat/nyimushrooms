        ...
        <AdminLayout title="Produksi Baglog">
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-6">
                <div className="bg-surface-container-lowest rounded-xl shadow-clinical-sm p-4">
                    ...
                    <p className="text-2xl font-bold text-on-surface">{summary.totalBulanIni}</p>
                </div>
                {tahaps.map((tahap) => (
                    <div key={tahap} className="bg-surface-container-lowest rounded-xl shadow-clinical-sm p-4">
                        <p className="text-sm text-on-tertiary-container capitalize">{tahap}</p>
                        <p className="text-2xl font-bold text-on-surface">{summary[tahap] || 0}</p>
                    </div>
                ))}
            </div>
            ...
            <div className="bg-surface-container-lowest rounded-xl shadow-clinical-sm">
                <div className="p-6 border-b border-outline-variant/15">
                    <div className="flex items-center justify-between">
                        <h2 className="text-lg font-headline font-bold text-on-surface">Daftar Produksi</h2>
                        <Link
                    ...
                    <table className="w-full">
                        <thead className="bg-surface-container-low">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left text-xs font-medium text-on-tertiary-container uppercase">Tahap</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-on-tertiary-container uppercase">Operator</th>
