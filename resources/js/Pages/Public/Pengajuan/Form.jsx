...
export default function PublicPengajuanForm({ kategoris }) {
    ...
    return (
        <PublicLayout
            title="Form Pengajuan Pengeluaran"
            subtitle="Isi form di bawah untuk pengajuan pengeluaran dari kas Defila"
        >
